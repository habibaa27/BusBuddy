...
//     { icon: 'cube-outline', label: 'Couriers' },
//     { icon: 'globe-outline', label: 'City to City' },
...
//           <Text style={styles.profileName}>Habiba</Text>
...
//   },
//   driverModeButton: {
//     backgroundColor: '#8CD205', // Green color for the button
//     width: '90%',
//     paddingVertical: 15,
//     borderRadius: 10,
//     alignItems: 'center',
...
//   // State to toggle side menu visibility
